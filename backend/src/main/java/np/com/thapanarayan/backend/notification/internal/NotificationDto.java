...
public record NotificationDto(String id, String signalId, String title, String body, boolean read, String createdAt) {
    ...
    static NotificationDto from(Notification n) {
        return new NotificationDto(n.getId().toString(),
                ...
                n.getTitle(), n.getBody(), n.isReadFlag(), n.getCreatedAt().toString());
    }
}
